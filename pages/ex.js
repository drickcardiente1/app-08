  ...
  if (e.getAttribute("checked")) {
    ...
    for (w = 0; w < i.length; w++)
      i[w].classList.contains("text-white") &&
        (i[w].classList.remove("text-white"), i[w].classList.add("text-dark"));
    for (w = 0; w < s.length; w++)
      !s[w].classList.contains("text-white") ||
        s[w].closest(".sidenav") ||
        s[w].closest(".card.bg-gradient-dark") ||
        (s[w].classList.remove("text-white"), s[w].classList.add("text-dark"));
    for (w = 0; w < o.length; w++)
      o[w].classList.contains("text-white") &&
        (o[w].classList.remove("text-white"), o[w].classList.add("text-dark"));
    for (w = 0; w < d.length; w++)
      d[w].classList.contains("text-white") &&
        !d[w].closest(".sidenav") &&
        (d[w].classList.remove("text-white"), d[w].classList.add("text-dark"));
    ...
    for (w = 0; w < h.length; w++)
      h[w].closest(".card.bg-gradient-dark") ||
        (h[w].classList.remove("text-white"), h[w].classList.add("text-dark"));
    ...
    for (var w = 0; w < i.length; w++)
      i[w].classList.contains("text-dark") &&
        (i[w].classList.remove("text-dark"), i[w].classList.add("text-white"));
    for (var w = 0; w < l.length; w++)
      l[w].classList.contains("text-dark") &&
        (l[w].classList.remove("text-dark"), l[w].classList.add("text-white"));
    for (var w = 0; w < r.length; w++)
      r[w].classList.contains("text-dark") &&
        (r[w].classList.remove("text-dark"), r[w].classList.add("text-white"));
    for (var w = 0; w < c.length; w++)
      c[w].classList.contains("text-dark") &&
        (c[w].classList.remove("text-dark"), c[w].classList.add("text-white"));
    ...
    for (var w = 0; w < f.length; w++)
      f[w].classList.remove("text-dark"), f[w].classList.add("text-white");
